...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" action={{ route('admin.product.update',['product'=>$product->id])}} method="POST">
                @method('PUT')
                @csrf
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="inputEmail3" placeholder="نام محصول را وارد کنید" value="{{$product->name}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="price" class="form-control" id="inputPassword3" placeholder="قیمت را وارد کنید" value="{{$product->price}}">
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">موجودی</label>
                        <input type="number" name="inventory" class="form-control" id="inputPassword3" placeholder="موجودی را وارد کنید" value="{{$product->inventory}}">
                    </div>
                    <div class="form-group">
